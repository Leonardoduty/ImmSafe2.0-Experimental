...
"[project]/lib/country-danger-levels.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/route-engine.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$country$2d$danger$2d$levels$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/country-danger-levels.ts [app-ssr] (ecmascript)");
;
...
function analyzeRoute(source, destination, travelMode) {
    ...
    dangerousCountries.forEach((country)=>{
        const dangerLevel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$country$2d$danger$2d$levels$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCountryDangerLevel"])(country);
...
"[project]/lib/route-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const RouteContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function RouteProvider({ children }) {
    ...
    const updateAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (routeData.source && routeData.destination) {
            const analysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$route$2d$engine$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["analyzeRoute"])(routeData.source, routeData.destination, routeData.travelMode);
            setRouteData((prev)=>({
                    ...prev,
                    analysis
                }));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(RouteContext.Provider, {
        value: {
            routeData,
            setRouteData,
            updateAnalysis
        ...
        fileName: "[project]/lib/route-context.tsx",
        lineNumber: 66,
        columnNumber: 5
    }, this);
}
function useRoute() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(RouteContext);
    if (!context) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f004c555._.js.map