...
"[project]/lib/route-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const RouteContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function RouteProvider({ children }) {
    ...
    const updateAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RouteProvider.useCallback[updateAnalysis]": ()=>{
            if (routeData.source && routeData.destination) {
                const analysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$route$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["analyzeRoute"])(routeData.source, routeData.destination, routeData.travelMode);
                setRouteData({
                    "RouteProvider.useCallback[updateAnalysis]": (prev)=>({
                            ...prev,
                            analysis
                        })
                }["RouteProvider.useCallback[updateAnalysis]"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RouteContext.Provider, {
        value: {
            routeData,
            setRouteData,
            updateAnalysis
...
_s(RouteProvider, "j3vqyFjYJ3jRWl9DTNP66L3gE14=");
_c = RouteProvider;
function useRoute() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(RouteContext);
    if (!context) {
        throw new Error("useRoute must be used within RouteProvider");
    }
    return context;
}
_s1(useRoute, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
...
//# sourceMappingURL=_518ec711._.js.map