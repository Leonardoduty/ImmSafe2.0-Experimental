...
"[project]/lib/openroute-service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getRouteFromOpenRouteService(source, destination, profile = "foot-walking") {
    ...
    try {
        ...
        const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_ORS_API_KEY || "5b3ce3597851110001cf6248e77c1e5486f14a9c86eb135c57a6c432";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$openroute$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/openroute-service.ts [app-client] (ecmascript)");
;
...
async function getGlobalRoute(source, destination, travelMode = "walking") {
    ...
    const orsRoute = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$openroute$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRouteFromOpenRouteService"])(source, destination, travelMode === "walking" ? "foot-walking" : "driving-car");
...
"[project]/lib/ngo-centers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data/mapLayers/global-layers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GLOBAL_SAFE_ZONES = [
    ...
    },
    {
        lat: 15.5007,
        lon: 32.5599,
        label: "Khartoum Safe Area",
        country: "Sudan"
    },
    {
        lat: 4.3276,
        lon: 15.3136,
        label: "Kinshasa Safe Zone",
        country: "DRC"
    },
    // Asia
    {
        lat: 34.5553,
        lon: 69.2075,
        label: "Kabul Safe Zone",
        country: "Afghanistan"
    },
    {
        lat: 33.6844,
        lon: 73.0479,
        label: "Islamabad Camp",
        country: "Pakistan"
    },
    {
        lat: 24.8607,
        lon: 67.0011,
        label: "Karachi Safe Area",
        country: "Pakistan"
    },
    // Europe
    {
...
const GLOBAL_CONFLICT_ZONES = [
    // Middle East
    {
        lat: 33.5138,
        lon: 36.2765,
        label: "Damascus Conflict",
        country: "Syria"
    },
    {
        lat: 31.927,
    ...
    // Africa
    {
        lat: 15.5007,
        lon: 32.5599,
        label: "Khartoum Conflict",
        country: "Sudan"
    },
    {
        lat: 13.5,
        lon: 25.0,
        label: "Darfur Conflict",
        country: "Sudan"
    },
    {
        lat: 1.6956,
    ...
    // Asia
    {
        lat: 34.5553,
        lon: 69.2075,
        label: "Kabul Conflict",
        country: "Afghanistan"
    },
    {
        lat: 15.3694,
        lon: 48.2219,
        label: "Sanaa Conflict",
        country: "Yemen"
    },
    {
        lat: 48.3794,
    ...
    // Americas
    {
        lat: 4.7110,
        lon: -74.0721,
        label: "Colombia Conflict",
        country: "Colombia"
    }
];
const GLOBAL_WATER_POINTS = [
    // Middle East
    {
        lat: 31.9539,
        lon: 35.9106,
        label: "Jordan Water Point",
        country: "Jordan"
    },
    {
        lat: 33.8547,
    ...
    },
    {
        lat: 41.0082,
        lon: 28.9784,
        label: "Istanbul Water",
        country: "Turkey"
    }
];
const GLOBAL_BORDER_CHECKPOINTS = [
    // Middle East borders
    {
        lat: 33.0,
        lon: 35.8,
...
function getLayerPoints(layerType) {
    switch(layerType){
        case "safe_zones":
...
function getPointsInBounds(points, bounds, padding = 5) {
    return points.filter((point)=>point.lat >= bounds.minLat - padding && point.lat <= bounds.maxLat + padding && point.lon >= bounds.minLon - padding && point.lon <= bounds.maxLon + padding);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ngo$2d$centers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ngo-centers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/data/mapLayers/global-layers.ts [app-client] (ecmascript)");
;
...
function InteractiveMap({ onSourceSelect, onDestinationSelect, selectedRoute, routeCoordinates, activeLayers = [] }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InteractiveMap.useEffect": ()=>{
            if (routeCoordinates?.source && routeCoordinates?.destination) {
                ...
                setRoutePolyline([]);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$routing$2d$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGlobalRoute"])(source, destination, "walking").then({
                    "InteractiveMap.useEffect": (route)=>{
                        ...
                        if (route && route.length > 0) {
                            ...
                            const validRoute = route.filter({
                                "InteractiveMap.useEffect.validRoute": (point)=>typeof point.lat === "number" && typeof point.lon === "number" && !isNaN(point.lat) && !isNaN(point.lon) && point.lat >= -90 && point.lat <= 90 && point.lon >= -180 && point.lon <= 180
                            }["InteractiveMap.useEffect.validRoute"]);
                            if (validRoute.length > 0) {
                                setRoutePolyline(validRoute);
                            } else {
                                // Fallback if validation fails
                                setRoutePolyline((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$map$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateRoutePolyline"])(source, destination));
                            }
                        } else {
                            setRoutePolyline((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$map$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateRoutePolyline"])(source, destination));
                        }
    ...
    const drawMap = ()=>{
        ...
        const bounds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$map$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateBounds"])(routeCoordinates?.source, routeCoordinates?.destination, routePolyline);
        // Helper function to project points using the calculated bounds
        const projectPointLocal = (lat, lon)=>{
        ...
        if (activeLayers.includes("safe_zones")) {
            const safeZones = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPointsInBounds"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayerPoints"])("safe_zones"), bounds);
        ...
        if (activeLayers.includes("conflict_zones")) {
            const conflictZones = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPointsInBounds"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayerPoints"])("conflict_zones"), bounds);
        ...
        if (activeLayers.includes("water_points")) {
            const waterPoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPointsInBounds"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayerPoints"])("water_points"), bounds);
        ...
        if (activeLayers.includes("checkpoints")) {
            const checkpoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPointsInBounds"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$mapLayers$2f$global$2d$layers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayerPoints"])("checkpoints"), bounds);
        ...
        if (activeLayers.includes("hospitals")) {
            const visibleCenters = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ngo$2d$centers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HELP_CENTERS"].filter((c)=>c.lat >= bounds.minLat - 5 && c.lat <= bounds.maxLat + 5 && c.lon >= bounds.minLon - 5 && c.lon <= bounds.maxLon + 5);
    ...
    const handleCanvasClick = (e)=>{
        ...
        for (const point of dynamicMapPoints){
            const projected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$map$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectToCanvas"])(point.lat, point.lon, bounds, canvas.width, canvas.height);
...
_s(InteractiveMap, "X4ZQbQ0Qp1k4Ovh1UcakisfUuVQ=");
_c = InteractiveMap;
var _c;
...
_s(MapContainer, "0nJSea+3pp0qpC2VPOIPu6rV9yU=");
_c = MapContainer;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$route$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/route-context.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function RoutePanel({ onRouteSelect, onCoordinatesChange }) {
    _s();
    const { routeData, setRouteData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$route$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoute"])();
    ...
    const [source, setSource] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(routeData.source || null);
    const [destination, setDestination] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(routeData.destination || null);
    const [travelMode, setTravelMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(routeData.travelMode || "walking");
    const [analysis, setAnalysis] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(routeData.analysis || null);
...
_s(RoutePanel, "Z5xK/1OxDJWzlJjIbgOMP3So5cE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$route$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoute"]
    ];
});
_c = RoutePanel;
var _c;
...
"[project]/lib/ai-assistant.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/ai-assistant/ai-chat.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2d$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ai-assistant.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AIChat() {
    ...
    const handleSend = async ()=>{
        ...
        setIsLoading(true);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2d$assistant$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAIResponse"])(input);
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    message.suggestions && message.suggestions.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: message.suggestions.map((suggestion, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    message.resources && message.resources.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            message.resources.map((resource, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-xs opacity-90",
                                                    children: [
                                                        "- ",
                                                        resource
...
_s(AIChat, "+lbzt6YOiUYoqQ8jO+a/Snkvx7U=");
_c = AIChat;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$assistant$2f$ai$2d$chat$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ai-assistant/ai-chat.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Home() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ai$2d$assistant$2f$ai$2d$chat$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/app/page.tsx",
                lineNumber: 38,
                columnNumber: 7
            }, this)
...
//# sourceMappingURL=_21424c85._.js.map